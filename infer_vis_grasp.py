...
parser.add_argument('--dataset_root', default='/home/public/zhangliran/dataset')
parser.add_argument('--checkpoint_path', default='./logs/log_kn/minkuresunet_epoch10.tar')
parser.add_argument('--dump_dir', help='Dump dir to save outputs', default='./logs/log_kn/dump_epoch10/')
